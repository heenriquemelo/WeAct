...
<body id="page-top" class="index">
    ...
    <!-- Google Tag Manager -->
    <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-N22ZFN"
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <h1 class="intro-brand">WeAct</h1>
                <div class="intro-lead-in">Já sonhou em estudar fora?</div>
                <div class="intro-heading">Podemos te ajudar</div>
                <a href="#sobre" class="page-scroll transp-yellow">
                	<span class="fa-stack fa-3x">
                        <i class="fa fa-circle fa-stack-2x"></i>
                        <i class="fa fa-angle-down fa-stack-2x fa-inverse"></i>
                    </span>
                </a>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading" style="color: #555">Estamos aqui para ajudar</h3>
                </div>
            </div>
    ...
    <section id="team">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-white" id="extra-space">Autor</h2>
                </div>
            </div>
            <div class="row">
